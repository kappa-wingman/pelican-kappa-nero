...
var copyTargetText = (trigger) => {
  ...
  var copybuttonPromptText = 'Press to copy'; // Inserted from config
...
const addCopyButtonToCodeCells = () => {
  ...
  const codeCells = document.querySelectorAll('div.highlight pre') //Inserted from config
  ...
  //Inserted from config
    ...
    `<a class="copybtn o-tooltip--left" style="background-color: ${pre_bg}" data-tooltip="${messages[locale]['copy']}" data-clipboard-target="#${id}">
      <img src="/theme/images/copy-button.svg" alt="${messages[locale]['copy_to_clipboard']}">
    </a>`
